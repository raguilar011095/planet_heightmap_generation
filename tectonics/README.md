...
floor, continental area near the design band and mean continental thickness ≈ 39 km.
Continents deform as coherent bodies (`scripts/fragments.mjs` counts the pieces). 44 tests.
